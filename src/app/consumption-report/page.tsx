...
const ConsumptionReport = () => {
  ...
  const { data: monthsData, isLoading: isLoadingMonths } = useAvailableConsumptionMonth();
  ...
  const { data: reports, isLoading: isLoadingReports } = useConsumptionReport(
    yearMonth,
    !!yearMonth
  );
  const { data: statistic, isLoading: isLoadingStats } = useConsumptionStatistic(
    yearMonth,
    !!yearMonth
  );
